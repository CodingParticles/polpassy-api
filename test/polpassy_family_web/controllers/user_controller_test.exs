defmodule PolpassyFamilyWeb.UserControllerTest do
  use PolpassyFamilyWeb.ConnCase

  alias PolpassyFamily.Auth
  alias PolpassyFamily.Auth.User
  alias Plug.Test
  ...
  describe "sign_in user" do
    test "renders user when credentials are good", %{conn: conn, current_user: current_user} do
      conn =
        post(
          conn,
